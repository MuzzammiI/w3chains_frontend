      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-1/2 space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-2 text-sm text-gray-300">
            <span className="bg-purple-700 px-3 py-1 rounded-full">ERC-721</span>
      ...
      {selectedNftId && currentCollection ? (
        ...
        <div className="w-full rounded-xl  py-3 px-0 md:p-8 space-y-8 ">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start space-y-2 md:space-y-0 md:space-x-4">
            {/* Left Tabs */}
            <div className="flex space-x-2 p-2 bg-purple-mix rounded-lg shadow-inner">
              <DashboardButton
                isActive={true}
              >
                <div className="flex items-center">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm11.5 5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM12.95 7.55A3 3 0 119 12a3 3 0 013.95-4.45zM9 13a4 4 0 100-8 4 4 0 000 8z"
                      clipRule="evenodd"
                    />
                  </svg>
                  NFTs
              ...
              >
                <div className="flex items-center">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M10 18a8 8 0 100-16 8 8 0 000 16zm-7-8a7 7 0 1114 0 7 7 0 01-14 0zM10 9a1 1 0 011 1v3a1 1 0 11-2 0v-3a1 1 0 011-1z"
                      clipRule="evenodd"
                    />
                  </svg>
                  Tokens
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="max-w-full lg:w-1/4 bg-green-mix rounded-xl p-4 space-y-6 shadow-md">
              ...
              <div className="border-b border-purple-600 pb-4">
                ...
                >
                  Category
                  <ChevronIcon direction={isCategoryExpanded ? "up" : "down"} />
                </div>
                <div
                    ...
                    >
                      ...
                      <td
                        className={`px-4 py-4 whitespace-nowrap text-sm ${
                          nft.change1d >= 0 ? "text-green-400" : "text-red-400"
                        }`}
                      >
                        {nft.change1d >= 0 ? "+" : ""}
                        {nft.change1d}%
